...
import {useAttrs, ref, unref, watch, nextTick, getCurrentInstance, computed, toRef, watchEffect} from "vue";
...
async function handleCancel(e: Event) {
  e?.stopPropagation();
  // 过滤自定义关闭按钮的空白区域
  if ((e.target as HTMLElement)?.classList?.contains('close--custom')) return;
...
<template>
  <BasicModal v-bind="getBindValue" @cancel="handleCancel">
